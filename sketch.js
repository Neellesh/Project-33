...
function setup() 
{
  ...
  mute_btn.position(500,20);
  mute_btn.size(50,50);
  mute_btn.mouseClicked(mute);
  
  rope = new Rope(3,{x:55,y:405});
  rope2 = new Rope(5,{x:290,y:280});
  ...
  bunny = createSprite(365,108,100,100);
  bunny.scale = 0.2;
  ...
  bub = createSprite(375,430);
  bub.addImage("bubble",bubImg);
  bub.scale = 0.09
